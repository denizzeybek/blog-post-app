  ...
  <div class="flex flex-col gap-2">
    ...
    <div class="flex items-center gap-1">
      ...
      >
        <template #footer>
          <div
            v-if="primeProps?.selectionMode === 'range'"
            class="py-5 flex flex-wrap gap-2"
          >
            <Button
              v-for="(prop, idx) in buttonProps"
              :key="idx"
              @click="handleChange(prop.key)"
